...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Prof. Dr. Bucher, Gregor / Abt. Evolutionäre Entwicklungsgenetik, Uni
          Göttingen
          <br />
          ...
          <br />
          E-Mailadresse: gregor.bucher***bio.uni-goettingen.de
          <br />
    ...
    content: (
      <>
        <p>
          ...
          verarbeitet: der von Ihnen verwendete Browsertyp und die
...
const DataProtection = () => {
  return <InfoCard intro={intro} sections={sections} />;
};

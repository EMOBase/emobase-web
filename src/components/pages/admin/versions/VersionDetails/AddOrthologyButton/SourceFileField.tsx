...
function SourceFileFieldContent({ field }: { field: AnyFieldApi }) {
...
const SourceFileField = withForm({
  ...formOptions,
  render: ({ form }) => (
    <form.AppField
      name="file"
      children={(field) => <SourceFileFieldContent field={field} />}
    />
  ),
});

export default SourceFileField;
